...
open class GlitchLabel: UILabel {
    ...
    fileprivate func getChannelsImage(_ x1: CGFloat, x2: CGFloat, x3: CGFloat) -> UIImage {
        ...
        blueImage.draw(in: bounds + CGRect(x: x3, y: 0, width: 0, height: 0),
                             blendMode: blendMode,
                             alpha: CGFloat(globalAlpha))
        var channelsImage = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()
        
        if channelsImage == nil {
            channelsImage = UIImage.init()
        }
    ...
    fileprivate func getScanlineImage(_ channelsImage: UIImage) -> UIImage {
        ...
        var scanlineImage = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()
        
        if scanlineImage == nil {
            scanlineImage = UIImage.init()
        }
    ...
    fileprivate func getRedImage(_ rect: CGRect) -> UIImage {
        ...
        var redImage: UIImage = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
        
        if redImage == nil {
            redImage = UIImage.init()
        }
    ...
    fileprivate func getGreenImage(_ rect: CGRect) -> UIImage {
        ...
        var greenImage: UIImage = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
        
        if greenImage == nil {
            greenImage = UIImage.init()
        }
    ...
    fileprivate func getBlueImage(_ rect: CGRect) -> UIImage {
        ...
        var blueImage: UIImage = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
        
        if blueImage == nil {
            blueImage = UIImage.init()
        }
